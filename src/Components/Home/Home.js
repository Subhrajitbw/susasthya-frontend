                    ...
                    <div className="banner-wrapper">
                        ...
                        <div className="search-box">
                            <form action="templateshub.net">
                                <div className="form-group px-4 w-100">
                                    <input type="text" className="form-control" placeholder="Name" />
                                    <span className="form-text">Enter your Name</span>
                                </div>
                                <div className="form-group px-4 w-100">
                                ...
                                <div className="form-group px-4 w-100">
                                    <input type="text" className="form-control" placeholder="Problem"/>
                                    <span className="form-text">Problem</span>
                                </div>
                                <Link to="/know-your-disease" className="btn btn-primary search-btn"><i className="fas fa-arrow-right" /> <span>Proceed</span></Link>
                            </form>
                        </div>
                        {/* /Search */}
                    </div>
